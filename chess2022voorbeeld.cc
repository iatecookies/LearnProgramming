...
/*
     //als zwarte koning op rand zit en dame staat 1 rij dus op 2 of op thesize -1
    if (kopie.xBK == 1 || kopie.xBK == kopie.thesize || kopie.yBK == 1 || kopie.yBK == kopie.thesize){ 
        // Dame staat dicht in buurt van Koning 
        if ( (afstand_WQ_BK > 1)){
...
*/
    ...
    if (kopie.xBK == 1 || kopie.xBK == kopie.thesize || kopie.yBK == 1 || kopie.yBK == kopie.thesize){
        ...
        if ( ((kopie.yWQ == 2 && kopie.yBK == 1) || (kopie.yWQ == kopie.thesize-1 && kopie.yBK == kopie.thesize) ||  (kopie.xWQ == 2 && kopie.xBK == 1) || (kopie.xWQ == kopie.thesize-1 && kopie.xBK == kopie.thesize)) && afstand_WQ_BK > 1){
